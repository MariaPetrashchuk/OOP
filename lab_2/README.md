...
* Результати виконання завданнь;
    ...
    1. Створили файли в яких будемо писати першу програму:  
        ...
        - [Pyton notebook з інтерактивним   виконанням коду](main.ipynb)
    1. Програма вивела значення :
        ![](image.png)
    1. Спробували попрацювати у Python ноутбуці, всі комірки виконались успішно [>>>>>Тиця сюди<<<<<](./main.ipynb)
...
1. сворили запит до Copilot який свторив прграму представлену нижче
    ...
    ```text
    << Тут можна писати те що хочемо відокремити >>
    ```
